...
class MCTS:
    ...
    def __init__(self, game_class, n_simulations, nn_model, cpuct=1.0, batch_size=32):
        ...
        # fila para batch predict: agora armazenamos também o estado completo
        self.pending_states = []
        self.pending_keys = []
        self.pending_game_states = []  # <--- nova lista para acessar valid moves reais
